...
vector<Vertex<T>*> Graph<T>::calculatePrim() {
    ...
    Vertex<T>* s = initSingleSource((*vertexSet.begin())->info);
...
vector<Vertex<T>*> Graph<T>::calculateKruskal() {
    ...
    // TODO: Do we need to define the comparison operator?
    priority_queue<Edge<T>> queue;
